...
Based on the retake attempt number calculate the final grade
     */
        ...
        if(attemptNumber == 1){
            finalGrade = grade * 0.9; // 90% of grade witch is minus 10%
        }else if(attemptNumber == 2){
            finalGrade = grade * 0.8; // 80% of grade witch is minus 20%
        }else if(attemptNumber == 3){
            finalGrade = grade * 0.65; // 65% of grade witch is minus 35%
        }
        // grade = grade*10%
