...
public class StringEquals {
    public static void main(String[] args) {
        ...
        String s = "java";
        String s2 = "java"; // both of these are String literal, so they are both in the String pool

        System.out.println("s == s2 " + (s == s2)); // checks if they are the same object, the same location, BUT it does not
        // check the value
        ...
        System.out.println("s == s3 " + (s == s3)); // comparing to different object
